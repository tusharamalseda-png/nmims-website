      ...
      scripts: [
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            name: "NMIMS Online",
            description:
              "An Affiliate Enquiry Partner (AEP) for NMIMS CDOE - an independent education counselling business, not NMIMS University or NMIMS CDOE itself - providing admission counselling for NMIMS CDOE's online degree programs across India since 2018.",
            foundingDate: "2018",
...
const waMessage =
  "Hi, I'd like to know more about NMIMS Online and how you help with NMIMS CDOE admissions.";

const personas = [
  {
    icon: GraduationCap,
    t: "Fresh Graduates",
    d: "Starting a career and looking for a recognised degree that opens doors from day one.",
  },
  {
    icon: Briefcase,
    t: "Working Professionals",
    d: "0–15 years of experience, upgrading qualifications without pausing their career.",
  },
  {
    icon: Building2,
    t: "Entrepreneurs & Business Owners",
    d: "Building formal management knowledge alongside running a business.",
  },
  {
    icon: Users,
    t: "Family Business Professionals",
    d: "Bringing structured business education into a family enterprise.",
  },
  {
    icon: Rocket,
    t: "Career Switchers",
    d: "Moving into management or a new function and need a credible degree to back the switch.",
  },
  {
    icon: UserCog,
    t: "Leadership Aspirants",
    d: "Preparing for promotion or a leadership role that expects a postgraduate qualification.",
  },
];
...
const whyChoose = [
  {
    icon: ShieldCheck,
    t: "Authorized NMIMS CDOE Enquiry Partner",
    d: "Associated with NMIMS CDOE since 2018, helping students make informed decisions with complete transparency.",
  },
  {
    icon: Users,
    t: "Trusted Across Gujarat",
    d: "Thousands of students and working professionals counselled across 10 cities - and counting.",
  },
  {
    icon: Clock,
    t: "15+ Years of Counselling Experience",
    d: "Our team has guided students through every stage of the admission journey, long before this partnership began.",
  },
  {
    icon: Handshake,
    t: "1:10 Counsellor-to-Student Ratio",
    d: "Personalised attention for every learner instead of a call-centre queue.",
  },
  {
    icon: CheckCircle2,
    t: "End-to-End Assistance",
    d: "From your first enquiry through documentation, fee guidance and exams, to graduation.",
  },
  {
    icon: HeartHandshake,
    t: "Support That Doesn't Stop at Admission",
    d: "We continue assisting with university processes and academic queries even after you enrol.",
  },
];
...
function Hero() {
  return (
    <section className="relative overflow-hidden bg-[#1f1b2e]">
      ...
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[linear-gradient(100deg,rgba(31,27,46,0.93)_15%,rgba(42,36,64,0.6)_55%,rgba(58,47,85,0.4)_100%)]"
        aria-hidden
      />
      <div
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-4 py-8 sm:px-6 sm:py-10 lg:grid-cols-[1.1fr_1fr] lg:gap-16 lg:py-[60px] lg:px-8">
        ...
        >
          ...
          <p className="mt-4 max-w-xl text-sm text-white/80 sm:text-base">
            Over the years, we have provided career counselling to 20,000+ aspiring learners across
            India, helping them make informed decisions about their higher education and career
            goals.
          </p>
      ...
      <div className="relative border-t border-white/10 bg-black/20 py-4 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-6 gap-y-2 px-4 text-xs font-semibold text-white/80 sm:gap-x-10 sm:text-sm">
          <span className="flex items-center gap-2">
            <ShieldCheck className="h-4 w-4 text-[#fbbf24]" /> Authorized AEP Since 2018
          </span>
          <span className="flex items-center gap-2">
            <Award className="h-4 w-4 text-[#fbbf24]" /> Represents a NAAC A++ University
          </span>
          <span className="flex items-center gap-2">
            <Star className="h-4 w-4 fill-[#fbbf24] text-[#fbbf24]" /> Zero Cost to Students
          </span>
          <span className="flex items-center gap-2">
            <Globe2 className="h-4 w-4 text-[#fbbf24]" /> PAN India
          </span>
        </div>
      </div>
    </section>
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 space-y-4 text-muted-foreground">
          <p>
            We have been working as an Affiliate Enquiry Partner (AEP) for NMIMS Centre for Distance
            and Online Education (CDOE) since 2018.
          </p>
          <p>
            Over the years, we have provided career counselling to more than 20,000 aspiring
            learners across India, helping them understand their higher education options and make
            informed decisions. We are proud that 2,000+ students have trusted us and chosen to
            begin or advance their academic journey through the programs offered by NMIMS CDOE.
          </p>
          <p>
            We assist prospective students by providing complete information about the programs
            offered by NMIMS CDOE, including eligibility, curriculum, specializations, fee
            structure, and the admission process. Our goal is to help every learner make an informed
            decision based on their educational and career aspirations.
          </p>
          <p>
            As an Affiliate Enquiry Partner (AEP) of NMIMS CDOE, our role is limited to displaying
            and explaining the programs offered by NMIMS CDOE and guiding students through the
            admission enquiry process.
          </p>
          <p>
            <strong className="font-semibold text-foreground">Please Note:</strong> Counselling,
            admission decisions, document verification, program delivery, learning management,
            examinations, evaluation, and the award of degrees or certificates are solely managed by
            NMIMS Centre for Distance and Online Education (CDOE). As an Affiliate Enquiry Partner,
            we do not have any role in these academic or administrative processes.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="Our programmes and guidance are designed for ambitious individuals balancing work, business or personal commitments."
        />
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="Choosing the right admission partner matters too"
          subtitle="Not just which university - who guides you there."
        />
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <section className="py-16 text-center sm:py-24">
      ...
      <div className="mx-auto mt-4 max-w-5xl px-4 sm:px-6 lg:px-8">
        <p className="text-base text-muted-foreground">
          We counsel students from major cities across India through phone, video consultations, and
          online support, ensuring every learner receives personalized assistance throughout the
          admission enquiry process.
        </p>
      </div>
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div>
          <SectionTitle
            align="left"
            eyebrow="The University We Represent"
            title="NMIMS CDOE - the degree behind our guidance"
          />
          <p className="mt-4 text-muted-foreground">
            SVKM's Narsee Monjee Institute of Management was founded in 1981 and achieved
            Deemed-to-be-University status from the UGC in 2003. NMIMS Centre for Distance and
            Online Education (CDOE) began its distance and online learning journey in 2013,
            delivering interactive, technology-enabled education to learners across India.
          </p>
          <p className="mt-3 text-muted-foreground">
            As an Authorized NMIMS CDOE Enquiry Partner, we are an independent counselling business
            - not NMIMS University or NMIMS CDOE itself. Every degree, class, exam and certificate
            is issued and governed solely by NMIMS CDOE; our role is limited to helping you reach
            them with clear information and honest guidance.
          </p>
          <div className="mt-6 flex items-start gap-3 rounded-2xl bg-secondary p-4">
            <MapPin className="mt-0.5 h-5 w-5 shrink-0 text-primary" />
            <p className="text-sm text-foreground">
              <strong className="font-bold">University Home Campus:</strong> SVKM's NMIMS, V.L.
              Mehta Road, Vile Parle (West), Mumbai, Maharashtra, India
            </p>
          </div>
          <div className="mt-6">
...
function OurRole() {
  const weHelp = [
    {
      t: "Program Information & Career Guidance",
      d: "Provides accurate information about NMIMS CDOE programs, eligibility, specializations, fee structure, and career opportunities.",
    },
    {
      t: "Admission Enquiry Assistance",
      d: "Guides prospective students through the application process and assists them in understanding the admission requirements.",
    },
    {
      t: "Pre-Admission Support",
      d: "Helps students resolve admission-related queries and offers guidance until the application is submitted to NMIMS CDOE.",
    },
    {
      t: "Independent Facilitation",
      d: "Acts only as an Affiliate Enquiry Partner. Admissions, document verification, academic delivery, examinations, evaluation, certification, and student services are solely managed by NMIMS CDOE.",
    },
  ];
  const nmimsHandles = [
    {
      t: "Admissions & Document Verification",
      d: "Reviews applications, verifies documents, and confirms student admissions.",
    },
    {
      t: "Academic Delivery",
      d: "Conducts live and recorded lectures, provides LMS access, study material, and academic support.",
    },
    {
      t: "Examinations & Evaluation",
      d: "Manages examination scheduling, online proctoring, assessment, result declaration, and re-evaluation processes.",
    },
    {
      t: "Certification & Student Services",
      d: "Issues degrees/certificates, provides academic support, and handles all official student-related services throughout the program.",
    },
  ];
  return (
    <section className="py-16 sm:py-24" id="our-role">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="Our role, clearly explained"
          subtitle="We believe a trustworthy admission partner is upfront about exactly where its role starts and ends."
        />
    ...
    <section className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#1f1b2e_0%,#2a2440_55%,#3a2f55_100%)] p-8 text-center shadow-elegant sm:p-14">
        ...
        <p className="relative mx-auto mt-4 max-w-xl text-white/85">
          Get a callback, chat instantly on WhatsApp, or join a free info session - no pressure, no
          fee, just honest guidance.
        </p>
        <div className="relative mt-8 flex flex-wrap justify-center gap-3">
          ...
          <a
            href={waLink(
              "Hi, I'd like to know more about NMIMS Online. Please share more details.",
            )}
            target="_blank"
            rel="noopener"
