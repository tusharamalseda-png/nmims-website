      ...
      scripts: [
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            description:
              "UGC-entitled 6-month Certificate in Business Management offered by NMIMS Centre for Distance and Online Education (CDOE), covering business communication, financial accounting, marketing management, economics and organisational behaviour.",
            provider: {
...
const outcomes = [
  {
    ...
    d: "Apply core business, marketing and communication skills in growth-focused roles.",
  },
  {
    icon: TrendingUp,
    t: "Business Strategy Manager",
    d: "Build a foundation in business frameworks to support strategic decision-making.",
  },
  {
    icon: BookOpen,
    t: "Understand Business Challenges",
    d: "Develop the ability to interpret business challenges using management principles.",
  },
  {
    icon: CheckCircle2,
    t: "Apply Management Principles",
    d: "Implement strategies that enhance organisational performance in your current role.",
  },
];
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-8 sm:px-6 sm:py-10 lg:grid-cols-[1.1fr_1fr] lg:gap-16 lg:py-[60px] lg:px-8">
        ...
        >
          ...
          <p className="mt-4 max-w-xl text-sm text-white/80 sm:text-base">
            Skill up and stand out in no time. A UGC-entitled, 6-month online certificate from NMIMS
            CDOE that builds a solid foundation in core business fundamentals - in a single
            semester.
          </p>
...
function WhyChoose() {
  const items = [
    {
      icon: Clock,
      t: "Skill Up in No Time",
      d: "A focused 6-month certificate - build core business fundamentals without a long-term commitment.",
    },
    {
      icon: Video,
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="Skill up and stand out in no time"
          subtitle="A six-month certificate built around flexibility, faculty quality and a well-rounded business foundation."
        />
  ...
  return (
    <section className="py-16 sm:py-24" id="curriculum">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          eyebrow="Curriculum"
          title="A Single-Semester Business Foundation"
          subtitle="One semester, six subjects - a well-rounded introduction to core business concepts."
        />
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <div>
          <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-[#ffd7c9] ring-1 ring-white/20">
            <span className="h-[7px] w-[7px] rounded-full bg-[#ffd7c9]" /> Certificate & Alumni
            Status
          </span>
          ...
          <p className="mt-3 max-w-lg text-white/85">
            Earn an official Certificate in Business Management from NMIMS CDOE that recognises your
            dedication to learning and pursuit of excellence.
          </p>
        ...
        <div className="rounded-3xl border border-white/15 bg-white/[.06] p-6 text-center">
          <img
            ...
            alt="NMIMS Certificate in Business Management sample"
            loading="lazy"
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="What This Certificate Prepares You For"
          subtitle="A well-rounded introduction to core business concepts, with a direct line to these roles."
        />
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="Program Fee"
          subtitle="A single, flat fee for the full 6-month programme."
        />
        <div className="mx-auto mt-12 max-w-sm">
          <div className="group relative flex flex-col overflow-hidden rounded-3xl border border-border bg-card p-8 text-center shadow-card transition-all duration-300 hover:-translate-y-1 hover:border-transparent hover:bg-[linear-gradient(135deg,#785BEB,#3F3083)] hover:shadow-elegant">
            ...
            <p className="mt-4 text-4xl font-extrabold text-[#3F3083] transition-colors duration-300 group-hover:text-[#ffd24d]">
              ₹55,000{" "}
              <span className="block text-sm font-medium text-muted-foreground transition-colors duration-300 group-hover:text-white/70">
                excluding GST
              </span>
            </p>
            <ul className="mx-auto mt-5 space-y-2.5 text-left text-sm text-muted-foreground transition-colors duration-300 group-hover:text-white">
              {[
                "Single, one-time program fee",
                "Covers the full 6-month programme",
                "Loan facility available without a credit card",
              ].map((f) => (
        ...
        <div className="mx-auto mt-8 max-w-3xl space-y-2.5 rounded-2xl border border-border bg-card p-6 text-xs text-muted-foreground shadow-card">
          ...
          <p className="flex gap-2">
            <Wallet className="h-4 w-4 shrink-0 text-primary" /> A loan facility to pay fees without
            a credit card is available; finance options are available on request.
          </p>
          <p className="flex gap-2">
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="A simple 4-step process to begin your Certificate journey with NMIMS CDOE."
        />
    ...
    <section className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#1f1b2e_0%,#2a2440_55%,#3a2f55_100%)] p-8 text-center shadow-elegant sm:p-14">
        ...
        <p className="relative mx-auto mt-4 max-w-xl text-white/85">
          ...
          about the NMIMS Certificate in Business Management.
        </p>
        <div className="relative mt-8 flex flex-wrap justify-center gap-3">
          ...
          <a
            href={waLink(
              "Hi, I'm interested in the NMIMS Certificate in Business Management. Please share more details.",
            )}
            target="_blank"
            rel="noopener"
