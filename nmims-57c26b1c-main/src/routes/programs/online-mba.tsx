      ...
      scripts: [
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 3,
                name: "Online MBA",
                item: "https://cdoe.info/programs/online-mba",
              },
            ],
          }),
        },
        {
          ...
          children: JSON.stringify({
            ...
            name: "Online MBA",
            description:
              "UGC-DEB entitled 2-year Online MBA offered by NMIMS Centre for Distance and Online Education (CDOE), with 7+ specialisations, live faculty-led sessions and career services.",
            provider: {
...
const specializations = [
  {
    ...
    desc: "Master corporate finance, investment strategies and financial decision-making.",
  },
  {
    icon: Briefcase,
    name: "Business Management",
    desc: "Build leadership skills and strategic thinking to drive organisational growth.",
  },
  {
    icon: Megaphone,
    name: "Marketing Management",
    desc: "Learn brand strategy, digital marketing and consumer behaviour insights.",
  },
  {
    icon: UserCog,
    name: "Human Resource Management",
    desc: "Develop people management, talent acquisition and HR strategy expertise.",
  },
  {
    icon: Layers,
    name: "Operations & Data Science",
    desc: "Combine operational efficiency with data-driven decision making skills.",
  },
  {
    icon: Cpu,
    name: "IT Management",
    desc: "Bridge technology and business with IT strategy and digital transformation.",
  },
  {
    icon: TrendingUp,
    name: "Business Analytics",
    desc: "Turn complex data into actionable insights with analytics and visualisation tools.",
  },
];
    ...
    <section className="relative overflow-hidden bg-[linear-gradient(135deg,#1f1b2e_0%,#2a2440_55%,#3a2f55_100%)]">
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-8 sm:px-6 sm:py-10 lg:grid-cols-[1.1fr_1fr] lg:gap-16 lg:py-[60px] lg:px-8">
        ...
        >
          ...
          <p className="mt-4 max-w-xl text-sm text-white/80 sm:text-base">
            Ready to take your career to the next level? The NMIMS Online MBA is designed for
            working professionals and graduates who want a globally recognised management degree
            without pausing their career.
          </p>
      ...
      <div className="relative border-t border-white/10 bg-black/20 py-4 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-6 gap-y-2 px-4 text-xs font-semibold text-white/80 sm:gap-x-10 sm:text-sm">
          ...
          <span className="flex items-center gap-2">
            <Award className="h-4 w-4 text-[#fbbf24]" /> NAAC A++
          </span>
          <span className="flex items-center gap-2">
            <Star className="h-4 w-4 fill-[#fbbf24] text-[#fbbf24]" /> 4.8/5 · 12,000+ learners
          </span>
          <span className="flex items-center gap-2">
...
function WhyChoose() {
  const items = [
    ...
    },
    {
      icon: Laptop,
      t: "Recorded Sessions",
      d: "Lifetime access to high-quality recordings - learn at your own pace.",
    },
    {
      icon: GraduationCap,
      t: "Experienced Faculty",
      d: "Learn from academicians and industry leaders with years of experience.",
    },
    {
      icon: Briefcase,
      t: "Career Services",
      d: "1:1 career coaching, resume review and access to 700+ hiring partners.",
    },
    {
      icon: Clock,
      t: "Flexible Learning",
      d: "Study evenings & weekends without putting your career on hold.",
    },
    {
      icon: Headphones,
      t: "24×7 Student Support",
      d: "Dedicated mentors, doubt-solving and academic guidance whenever you need.",
    },
  ];
  return (
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="A management degree built around your career, not the other way around."
        />
...
function Specializations() {
  return (
    <section className="py-16 sm:py-24" id="specialisations">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          eyebrow="MBA Specialisations"
          title="Choose a track that matches your ambition"
          subtitle="Every specialisation is industry-aligned and taught by experienced faculty."
        />
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col items-start justify-center rounded-3xl gradient-primary p-6 text-primary-foreground shadow-card">
            ...
            <p className="mt-2 text-sm text-primary-foreground/90">
              Talk to a counsellor and choose the right specialisation for your goals.
            </p>
    ...
    <section className="bg-surface-soft py-16 sm:py-24" id="curriculum">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="A structured, industry-relevant curriculum - core management fundamentals in Year 1, specialisation depth in Year 2."
        />
        ...
        <p className="mx-auto mt-6 max-w-3xl text-center text-xs text-muted-foreground">
          Curriculum structure is indicative and subject to periodic revision by NMIMS CDOE.
          Electives are chosen as per your selected specialisation.
        </p>
...
function LearningExperience() {
  const items = [
    {
      icon: Video,
      t: "Live Interactive & Recorded Lectures",
      d: "24/7 access to all content, including recorded sessions of every lecture.",
    },
    {
      icon: Smartphone,
      t: "Mobile App & Student Portal",
      d: "Attend classes, submit assignments and track progress from one dashboard.",
    },
    {
      icon: BookOpen,
      t: "E-Library & Digital Resources",
      d: "Access e-books, case studies and journals through the online library, anytime.",
    },
    {
      icon: GraduationCap,
      t: "High Focus on Academic Excellence",
      d: "Experienced academicians and industry experts with a globally curated curriculum.",
    },
    {
      icon: Headphones,
      t: "24×7 Student Support",
    ...
    {
      icon: Laptop,
      t: "Application-Oriented Assessment",
      d: "Computer-based exams at designated centres all over India.",
    },
  ];
  return (
    <section className="py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="A tech-enabled journey, built for professionals"
        />
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {items.map(({ icon: Icon, t, d }, i) => (
            <motion.div
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <div>
          ...
          <h2 className="mt-3 font-serif text-2xl font-bold sm:text-[30px] lg:text-[34px]">
            Earn Your NMIMS Certificate
          </h2>
          <p className="mt-3 max-w-lg text-white/85">
            Earn an official certificate from NMIMS CDOE that recognises your dedication to learning
        ...
        <div className="rounded-3xl border border-white/15 bg-white/[.06] p-6 text-center">
          <img
            ...
            alt="NMIMS Online MBA certificate sample"
            loading="lazy"
...
function CareerServices() {
  const items = [
    ...
    },
    {
      ...
      d: "Personalised guidance to map your specialisation to the right career path.",
    },
    {
      icon: FileSearch,
    ...
    },
    {
      ...
      d: "Stay current with sessions led by practitioners across sectors.",
    },
  ];
  return (
    <section className="bg-surface-soft py-16 sm:py-24">
    ...
    <section className="py-16 text-center sm:py-24">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="From BFSI to technology, our hiring-partner network spans industries hiring NMIMS CDOE graduates."
        />
      </div>
...
function CareerOptions() {
  const roles = [
    {
      t: "Marketing Manager",
      d: "Lead brand, digital and go-to-market strategy for a business unit.",
    },
    { t: "Financial Analyst", d: "Drive budgeting, forecasting and investment decision support." },
    {
      t: "HR Business Partner",
      d: "Align talent strategy with business goals across the employee lifecycle.",
    },
    {
      t: "Business Analyst",
      d: "Turn data into insights that inform strategic business decisions.",
    },
    {
      t: "Operations Manager",
      d: "Own process efficiency, supply chain and delivery performance.",
    },
    {
      t: "IT Project Manager",
      d: "Bridge business and technology teams to deliver digital initiatives.",
    },
    {
      t: "Management Consultant",
      d: "Advise organisations on strategy, growth and operational improvement.",
    },
    {
      t: "Entrepreneur / Founder",
      d: "Apply core management skills to build and scale your own venture.",
    },
  ];
  return (
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="Where This MBA Can Take You"
          subtitle="Representative roles pursued by NMIMS Online MBA graduates across specialisations."
        />
...
const FEE_PLANS = [
  {
    ...
    price: "₹1,05,000",
    suffix: "/ year",
    bullets: ["Pay once per year", "2 installments over 2 years", "Best value plan"],
  },
  {
    opt: "Option 2",
    ...
    price: "₹55,000",
    suffix: "/ semester",
    bullets: ["4 flexible installments", "Pay per semester", "Easier on monthly budget"],
  },
  {
    opt: "Option 3",
    title: "Full Payment",
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="Select a payment plan that works for you - pay semester-wise across 4 semesters, annually over 2 years, as a single one-time payment, or via EMI."
        />
        ...
        <div className="mx-auto mt-8 max-w-3xl space-y-2.5 rounded-2xl border border-border bg-card p-6 text-xs text-muted-foreground shadow-card">
          <p className="flex gap-2">
            <Wallet className="h-4 w-4 shrink-0 text-primary" /> Fees may vary slightly by
            specialisation; confirm the current schedule with your counsellor before enrolling.
          </p>
          <p className="flex gap-2">
            <Wallet className="h-4 w-4 shrink-0 text-primary" /> Processing, examination and
            project/dissertation fees (where applicable) are charged separately as per the official
            NMIMS CDOE fee schedule.
          </p>
          <p className="flex gap-2">
            <Wallet className="h-4 w-4 shrink-0 text-primary" /> 0% interest EMI options are
            available. Currently, no scholarships or concessions are available for the general
            category; a 20% fee concession applies for defence personnel and their immediate family.
          </p>
          <p className="flex gap-2">
  ...
  const steps = [
    {
      ...
      tag: "Step 1",
      t: "Registration",
      d: "Complete the online registration form and pay the application fee to begin your journey.",
    },
    {
      icon: FileCheck,
      tag: "Step 2",
      t: "Document Submission",
      d: "Submit academic documents, work experience proof (if any), and a valid photo ID.",
    },
    {
      icon: CreditCard,
      tag: "Step 3",
      t: "Fee Payment",
      d: "Pay your program fees online, or split them with easy 0% interest EMI options.",
    },
    {
      icon: CheckCircle2,
      tag: "Step 4",
      t: "Confirmation",
      d: "Your admission is confirmed and you receive an official student number.",
    },
  ];
  const docs = [
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="Simple 4-step process to begin your MBA journey with NMIMS CDOE."
        />
        ...
        <div className="mt-16 grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl border border-border bg-card p-6 shadow-card">
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              Admissions are processed on a rolling basis. Talk to your counsellor to confirm the
              exact intake calendar and re-registration schedule for each subsequent semester.
            </p>
          </div>
          <div className="rounded-3xl border border-border bg-card p-6 shadow-card">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            ...
            institutions for flexible, career-focused online education. Established in 1994 as the
            distance learning division of SVKM's NMIMS, the institute has consistently delivered
            high-quality academic programs designed to meet evolving industry demands.
          </p>
          <p className="mt-3 text-muted-foreground">
            With a strong focus on accessible learning, industry-relevant curriculum and student
            success, NMIMS CDOE empowers learners to build in-demand skills, achieve their career
            goals and excel in today's competitive business environment.
          </p>
          ...
          <div className="mt-6">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {["UGC-DEB Entitled", "NAAC A++", "AICTE Approved", "Category 1 Autonomy"].map(
                (b) => (
                  <span
                    key={b}
    ...
    <section className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#1f1b2e_0%,#2a2440_55%,#3a2f55_100%)] p-8 text-center shadow-elegant sm:p-14">
        ...
        <div className="relative mt-8 flex flex-wrap justify-center gap-3">
          ...
          <a
            href={waLink("Hi, I'm interested in the NMIMS Online MBA. Please share more details.")}
            target="_blank"
            rel="noopener"
