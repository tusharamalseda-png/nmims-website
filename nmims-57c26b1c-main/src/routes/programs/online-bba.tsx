      ...
      scripts: [
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            name: "Online BBA",
            description:
              "UGC-DEB entitled 3-year Online BBA offered by NMIMS Centre for Distance and Online Education (CDOE), with Marketing, Finance and Business Analytics specialisations.",
            provider: {
...
const specializations = [
  {
    icon: Megaphone,
    name: "Marketing",
    desc: "Digital marketing, retail management, consumer behaviour and brand strategy.",
  },
  {
    icon: Landmark,
    name: "Finance",
    desc: "Financial management, corporate finance, investment analysis and financial modelling.",
  },
  {
    icon: TrendingUp,
    name: "Business Analytics",
    desc: "Python, machine learning, Tableau visualisation and big data techniques for business.",
  },
];
      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-8 sm:px-6 sm:py-10 lg:grid-cols-[1.1fr_1fr] lg:gap-16 lg:py-[60px] lg:px-8">
        ...
        >
          ...
          <p className="mt-4 max-w-xl text-sm text-white/80 sm:text-base">
            Ready to start your career? The NMIMS Online BBA is a UGC-DEB entitled, 3-year
            undergraduate degree for school leavers and early-career learners who want a recognised
            business qualification with complete flexibility.
          </p>
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="An undergraduate degree built around flexibility, faculty quality and career readiness."
        />
...
function Specializations() {
  return (
    <section className="py-16 sm:py-24" id="specialisations">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          eyebrow="BBA Specialisations"
          title="Choose a track that matches your ambition"
          subtitle="Electives begin in Semester 4 - choose Marketing, Finance, or Business Analytics."
        />
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <section className="bg-surface-soft py-16 sm:py-24" id="curriculum">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="144 credits across 6 semesters - core business fundamentals first, specialisation electives from Semester 4."
        />
        ...
        <div className="mx-auto mt-10 max-w-3xl rounded-2xl border border-border bg-card p-6 shadow-card">
          <p className="mb-3 text-xs font-bold uppercase tracking-widest text-muted-foreground">
            Employability Skill Add-On Modules
          </p>
        ...
        <p className="mx-auto mt-6 max-w-3xl text-center text-xs text-muted-foreground">
          Programme credits: 144. Curriculum structure is as per university guidelines and subject
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <div>
          ...
          <p className="mt-3 max-w-lg text-white/85">
            Earn an official Bachelor of Business Administration degree from NMIMS CDOE that
            recognises your dedication to learning and career growth.
          </p>
        ...
        <div className="rounded-3xl border border-white/15 bg-white/[.06] p-6 text-center">
          <img
            src="/images/certificate-bba.jpg"
            alt="NMIMS Online BBA certificate sample"
            loading="lazy"
  ...
  const roles = [
    {
      icon: Megaphone,
      t: "Marketing",
      d: "Assistant manager / executive roles in brand, digital and sales functions.",
    },
    {
      icon: Landmark,
      t: "Finance",
      d: "Entry into financial analysis, accounting and corporate finance functions.",
    },
    {
      icon: UserCog,
      t: "HR",
      d: "Roles in talent acquisition, HR operations and people management.",
    },
    { icon: Layers, t: "Operations", d: "Process, supply chain and operations management roles." },
    {
      icon: Cpu,
      t: "Information Technology",
      d: "IT-enabled business roles bridging technology and management.",
    },
    {
      icon: Building2,
      t: "General Management",
      d: "Cross-functional management trainee and generalist roles.",
    },
    {
      icon: Handshake,
      t: "Business",
      d: "Business development and entrepreneurial opportunities.",
    },
  ];
  return (
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          title="Where This BBA Can Take You"
          subtitle="This programme prepares you to respond to the challenges of the corporate world as an assistant manager or executive across these domains."
        />
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="Fees vary by specialisation track - pay annually, semester-wise, as a full one-time payment, or via EMI."
        />
    ...
    <section className="bg-surface-soft py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="A simple 4-step process to begin your BBA journey with NMIMS CDOE."
        />
    ...
    <section className="px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#1f1b2e_0%,#2a2440_55%,#3a2f55_100%)] p-8 text-center shadow-elegant sm:p-14">
        ...
        <div className="relative mt-8 flex flex-wrap justify-center gap-3">
          ...
          <a
            href={waLink("Hi, I'm interested in the NMIMS Online BBA. Please share more details.")}
            target="_blank"
            rel="noopener"
