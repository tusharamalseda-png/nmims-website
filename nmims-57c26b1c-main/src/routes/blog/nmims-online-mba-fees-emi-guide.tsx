...
export const Route = createFileRoute("/blog/nmims-online-mba-fees-emi-guide")({
  loader: async () =>
    (await getBlogPostFn({ data: { slug: "nmims-online-mba-fees-emi-guide" } })) ?? FALLBACK_SEO,
  head: ({ loaderData }) => {
    ...
    const { meta, links } = buildSeoHead(
      "featuredImage" in seo ? { ...seo, ogImage: seo.featuredImage } : seo,
      {
        ...
        canonicalUrl: "/blog/nmims-online-mba-fees-emi-guide",
      },
    );
    return {
      meta,
      ...
      scripts: [
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            description:
              "Annual vs semester-wise fees, hidden costs, EMI options and the defence concession for the NMIMS CDOE Online MBA.",
...
const hiddenCosts = [
  ...
  [
    ...
    "₹10,000 (collected at registration, adjusted against total fee)",
  ],
...
const faqItems = [
  {
    q: "Is EMI available without a credit card?",
    a: "Yes. Alongside card-based EMI (3, 6, 9 or 12 months) via the banks listed above, a loan facility is also available for students who don't hold a credit card - ask your counsellor for current terms.",
  },
  {
    q: "Are there any scholarships for the NMIMS Online MBA?",
    a: "Currently, no scholarships or fee concessions are available for the general category. The only standing concession is 20% off the programme fee for defence and paramilitary personnel and their immediate family.",
  },
  {
    q: "What's the difference between the annual and semester-wise payment options?",
    a: "Annual payment (₹1,05,000/year) is billed as 2 instalments across the 2-year programme. Semester-wise payment (₹55,000/semester) splits the same total cost across 4 instalments, one per semester - useful if you'd rather spread cash flow more finely. There's no fee saving either way; it's purely about instalment size and frequency.",
  },
  {
    q: "What is the cheapest way to pay - full pay-in-full, annual, or semester-wise?",
    a: "Paying in full upfront (₹1,96,000) is the same total cost as paying annually or semester-wise for the standard track; NMIMS CDOE does not currently offer an early-payment discount on the MBA fee. Choose based on your cash flow, not on trying to save money by paying earlier.",
  },
  {
    q: "Do fees ever change after I've enrolled?",
    a: "The fee structure is set by NMIMS CDOE and is subject to change at the University's discretion for future intakes; once you're enrolled at a given fee structure, always reconfirm your specific instalment schedule with your counsellor rather than assuming it matches a later intake's published rate.",
  },
];
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
          <AnswerBox>
            The NMIMS CDOE Online MBA costs ₹1,05,000/year or ₹55,000/semester (₹1,96,000
            pay-in-full for the full 2-year programme), plus a one-time ₹1,200 admission processing
            fee and ₹800 per subject exam fee. No-cost EMI is available over 3, 6, 9 or 12 months
            via seven major banks, and defence personnel and their families get a 20% fee
            concession.
          </AnswerBox>

          <div className="prose-content mt-10 space-y-6 text-muted-foreground">
            <h2 className="text-xl font-extrabold text-foreground">
              The headline fee, two ways to pay it
            </h2>
            <p>
              The Online MBA's total programme fee is the same regardless of how you split it - what
              changes is instalment size and frequency:
            </p>
          </div>
          ...
          <div className="prose-content mt-8 space-y-6 text-muted-foreground">
            <h2 className="text-xl font-extrabold text-foreground">
              The costs people miss - budget for these too
            </h2>
            <p>
              Beyond the headline programme fee, a few smaller charges apply across the programme.
              None of these are hidden by NMIMS CDOE, but they're easy to miss when comparing fees
              across universities:
            </p>
          </div>
          ...
          <div className="prose-content mt-8 space-y-6 text-muted-foreground">
            <h2 className="text-xl font-extrabold text-foreground">
              EMI and no-credit-card options
            </h2>
            <p>
              EMI over 3, 6, 9 or 12 months is available via credit cards from the following banks.
              If you don't hold a credit card, a separate loan facility is also available - speak to
              your counsellor for current terms, as bank tie-ups and rates can change.
            </p>
          </div>
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            {emiBanks.map((b) => (
              <span
                key={b}
                className="rounded-full border border-border bg-card px-4 py-2 text-xs font-bold text-foreground shadow-card"
              >
                {b}
              </span>
            ))}
          ...
          <div className="mt-8 flex gap-3 rounded-2xl border border-primary/30 bg-secondary p-5 text-sm text-foreground">
            ...
            <p>
              <strong className="font-bold">Defence concession:</strong> Indian Army, Navy and Air
              Force personnel and their immediate family receive a 20% concession on the programme
              fee. Currently, no scholarships or concessions are available for the general category
              - we'd rather tell you that plainly than have you find out later.
            </p>
          </div>

          <div className="prose-content mt-10 space-y-4 text-muted-foreground">
            <h2 className="text-xl font-extrabold text-foreground">
              How the MBA fee compares to BBA and B.Com
            </h2>
            <p>
              If you're weighing the MBA against an undergraduate route, here's how the numbers
              stack up:
            </p>
          </div>
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            Figures shown are for the core/base track of each programme; always reconfirm current
            figures with your counsellor before enrolling, as fees are subject to change at the
      ...
      <div className="relative mx-auto max-w-3xl px-4 text-white sm:px-6 lg:px-8">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-4 text-xs font-semibold text-white/70">
          <span className="flex items-center gap-1.5">
            <Calendar className="h-3.5 w-3.5" /> 18 Jul 2026
          </span>
          <span className="flex items-center gap-1.5">
    ...
    <div className="mt-12 flex items-start gap-4 rounded-2xl border border-border bg-surface-soft p-5">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          ...
          business, not NMIMS University or NMIMS CDOE itself. All figures above are from the
          official NMIMS CDOE fee schedule and are subject to change at the University's discretion;
          always reconfirm current figures with your counsellor before enrolling.
        </p>
      </div>
    </div>
  );
    ...
    <section className="bg-surface-soft px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      <div className="relative mx-auto max-w-3xl overflow-hidden rounded-[2rem] bg-[linear-gradient(135deg,#1f1b2e_0%,#2a2440_55%,#3a2f55_100%)] p-8 text-center shadow-elegant sm:p-12">
        ...
        <p className="relative mx-auto mt-3 max-w-lg text-sm text-white/85">
          Talk to a counsellor about EMI plans, the defence concession, or how MBA fees compare to
          BBA and B.Com - free of cost.
        </p>
        <div className="relative mt-7 flex flex-wrap justify-center gap-3">
          ...
          <a
            href={waLink(
              "Hi, I read your blog post on MBA fees and would like to know more about EMI options.",
            )}
            target="_blank"
            rel="noopener"
