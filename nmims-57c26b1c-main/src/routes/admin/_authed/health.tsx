...
function HealthCheck() {
  ...
  const [linkResults, setLinkResults] = useState<
    { path: string; label: string; location: string }[] | null
  >(null);
    ...
    <div>
      ...
      <div className="mt-6 max-w-3xl">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-amber-700">
                  Missing{" "}
                  {[
                    m.missingMetaTitle && "meta title",
                    m.missingMetaDescription && "meta description",
                  ]
                    .filter(Boolean)
                    .join(" and ")}
                </p>
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          Checks every footer/header nav link against the site's real routes — no page loads, so
          this is instant.
        </p>
        <div className="mt-2">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-destructive/80">
                      "{r.label}" in {r.location} navigation points to a page that doesn't exist
                    </p>
                  </div>
                </div>
              ))}
